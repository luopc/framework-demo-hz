...
import com.cesgroup.demo.base.utils.LongDateTypeHandler;
 ...
 */
@Entity
@Table(name="t_fw_user_copy")
public class UserCopy extends StringIDEntity {
	...
	@ColumnType(typeHandler=LongDateTypeHandler.class)
