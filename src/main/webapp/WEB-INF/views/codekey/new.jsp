   ...
   <table class="table table-condensed tableNj table-bordered table-fixed">
		<tbody>
			<tr>
					...
					<td style="width:17%;"><cui:input componentCls="form-control"  name="keyName" required="true"/></td>
					<td style="width:8%;"><label>编码值</label></td>
					<td style="width:17%;"><cui:input componentCls="form-control"  name="keyValue" required="true"/></td>
