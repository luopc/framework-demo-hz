		...
		<tbody>
			<tr>
				...
				<td style="width: 17%;"><cui:input componentCls="form-control"
						name="userName" required="true" maxlength="20"/></td>
				<td style="width: 8%;"><label>密码</label></td>
				<td style="width: 17%;"><cui:input componentCls="form-control"
						name="userPass" required="true" type="password" maxlength="10"/></td>
			...
			<tr>
				...
				<td style="width: 17%;"><cui:combobox name="sex"
						componentCls="form-control" data="combobox_sex" required="true" /></td>
				</td>

				<td style="width: 8%;"><label>年龄</label></td>
				<td style="width: 17%;"><cui:input componentCls="form-control"
						name="age" validType="integer" maxlength="3" required="true"/>
				</td>
			</tr>
			<tr>
				<td style="width: 8%;"><label>电话</label></td>
				<td style="width: 17%;"><cui:input componentCls="form-control"
						name="phone" validType="mobile" required="true"/>
				</td>
			...
			<tr>
				...
				<td style="width: 17%;" colspan="3"><cui:textarea id="description" name="description" width="800" maxlength="200"></cui:textarea></div>     
				</td>
			</tr>
		</tbody>
	</table>
