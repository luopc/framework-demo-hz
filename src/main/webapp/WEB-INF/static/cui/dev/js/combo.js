...
$.component("coral.combo", $.coral.inputbase, {
	...
	_initCombo: function() {
		...
		this.uiCombo.textbox = $( "<input type='text' autocomplete='off' class='coral-combo-text coral-combo-default coral-textbox-default tabbable'>" ).appendTo(this.elementBorder);
