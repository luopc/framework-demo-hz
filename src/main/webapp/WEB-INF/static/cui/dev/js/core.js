...
(function() {
/*$.setView = function(controllerName, obj) {
...
/*$.view = function(controllerName) {
	if (window[controllerName]) {
		return window[controllerName].view;
	}
	return null;
}*/
/*$.getView = function(controllerName) {
	return window[controllerName];
}*/
$.coral = $.coral || {};
$.coral.openTag = true;
...
$.extend( $.coral, {
	...
	refreshAllComponent : function(parentComponent){
		...
		var layoutSet = null,
			layoutSetKey = "find",
			comStrictLayout = false,
			pType = $(parentComponent).attr("component-role");
		
		var t;
		if (!pType) {
			t = $(parentComponent).prop("strictLayout");
		} else {
			t = $(parentComponent)[pType]("option", "strictLayout");
		}
		if ( typeof t === "undefined" || t === null) {
			if ($.coral.strictLayout) {
				comStrictLayout = true;
			} else {
				comStrictLayout = false;
			}
		}
		...
		if (comStrictLayout && $.coral.strictLayout) {
			layoutSetKey = "children";
		}
		if (!comStrictLayout) {
			layoutSetKey = "find";
		}
		layoutSet = $(parentComponent)[layoutSetKey](
			".fill:visible, " +
		...
		layoutSet.each(function() {
			...
			if (!type) {
				...
				/*if (layoutSetKey === "find") {
					$ele[type]("option", "strictLayout", false);
				}*/
