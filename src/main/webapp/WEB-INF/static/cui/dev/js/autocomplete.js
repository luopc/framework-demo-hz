$.component( "coral.autocomplete", $.coral.inputbase,{
	...
	_initAutocomplete: function(){
		...
		if ( this.options.multiLineLabel ) {
			...
			this.element
				.addClass( "coral-validation-"+autocompleteCls+" coral-autocomplete-input coral-autocomplete-text coral-textbox-default tabbable" )
			...
			this.element
				.addClass( "coral-validation-"+autocompleteCls+" coral-autocomplete-input coral-autocomplete-text coral-textbox-default tabbable coral-form-element-autocomplete" )
				.attr( "autocomplete", "off" );
