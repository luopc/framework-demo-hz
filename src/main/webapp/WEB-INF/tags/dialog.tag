...
%><div id="<%=id %>" <%=(style == null ? "style='display:none;'" : "style='display:none;" + style+"'") %> <%=(cls == null ? "" : "class='"+cls+"'") %> data-options="<%=dataOption %>" ><jsp:doBody /></div>
